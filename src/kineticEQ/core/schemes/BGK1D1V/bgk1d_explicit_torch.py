# kineticEQ/src/kineticEQ/core/schemes/BGK1D1V/bgk1d_explicit_torch.py
...
from kineticEQ.core.schemes.BGK1D1V.bgk1d_utils.general.bgk1d_apply_BC import apply_bc
import logging
