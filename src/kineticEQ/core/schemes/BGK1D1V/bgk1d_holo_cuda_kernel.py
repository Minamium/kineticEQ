# kineticEQ/src/kineticEQ/core/schemes/BGK1D1V/bgk1d_holo_cuda_kernel.py
...
from kineticEQ.core.schemes.BGK1D1V.bgk1d_utils.general.bgk1d_set_initial_condition import set_initial_condition
from kineticEQ.core.schemes.BGK1D1V.bgk1d_utils.general.bgk1d_check_CFL import bgk1d_check_CFL
from kineticEQ.core.schemes.BGK1D1V.bgk1d_utils.general.bgk1d_compute_moments import calculate_moments
from kineticEQ.core.schemes.BGK1D1V.bgk1d_utils.explicit.bgk1d_compute_streaming import _compute_streaming_upwind
from kineticEQ.core.schemes.BGK1D1V.bgk1d_utils.general.bgk1d_maxwellian import maxwellian
from kineticEQ.core.schemes.BGK1D1V.bgk1d_utils.general.bgk1d_apply_BC import apply_bc, boundary_rows

from kineticEQ.core.schemes.BGK1D1V.bgk1d_utils.implicit.bgk1d_holo_ws import HoloWorkspace, allocate_holo_workspace
...
def step(
    ...
    for z in range(ho_iter):
        ...
        ws.B[:, 0].add_(alpha * f_bc_l)
        ws.B[:, -1].add_(beta * f_bc_r)
